...
import superiorImg from "../../assets/landing-page-images/superior-view.jpg";

export default function RoomsAndSuits() {
  return (
    <div className="m-auto pt-28 pb-[11.125rem] max-w-[1200px]">
      ...
      <div className="relative flex flex-col gap-6">
        ...
        <Link to="#">
          <img
            src={superiorImg}
            alt="Beautiful view from balcony"
            className="m-auto w-[1200px] h-[540px] relative object-cover object-bottom"
          />
          <div className="absolute bottom-20 left-16">
            <h2 className="text-[2.75rem] text-white font-noto-serif">
        ...
        {/* <div className="relative flex max-w-[1200px] gap-6">
          <Link to="#">
            <img
              src={superiorImg}
              alt="Beautiful view from balcony"
