...
export default function PaymentSection({
  ...
  return (
    <div className="m-auto my-6 w-[1120px] h-full flex justify-between gap-4 bg-utilBG">
      <div className="bg-white rounded-md flex-1 p-8 w-full">
        ...
        <div className="mt-8 flex justify-between">
          <button
            className="font-medium text-orange500 hover:bg-gray-300 hover:rounded-md px-8 py-2"
