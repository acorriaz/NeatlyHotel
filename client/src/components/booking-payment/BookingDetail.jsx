...
export default function BookingDetail({ requestCheckboxValue }) {
  ...
  return (
    <div className="flex flex-col gap-6 bg-utilBG">
      <div className="bg-[#4A5B51] rounded-md flex flex-col gap-4">
        ...
        <div className="flex justify-between gap-4">
          <div className="mx-4 mb-6">
            ...
            <p className="text-white font-inter">
              {requestCheckboxValue.earlyCheckIn === true
                ? "After 12.00AM"
                : "After 2:00PM"}
            </p>
          </div>
          <div className="mx-4 mb-6">
            ...
            <p className="text-white font-inter">
              {requestCheckboxValue.lateCheckOut === true
                ? "Before  2.00PM"
                : "Before 12:00PM"}
            </p>
          </div>
        ...
        <div className="mx-4 mb-6">
          <p className="text-white font-inter">
            {`${dateFormat(searchInput.checkIn)} - ${dateFormat(
