...
import TopBarRoomManagement from "../components/TopBarRoomManagement";
  ...
  return (
    ...
    >
      ...
      <main className="flex-1 flex flex-col items-start justify-start max-w-[calc(100%_-_240px)] mq1050:max-w-full">
        <TopBarRoomManagement />
        <section className="self-stretch h-[944px]  overflow-hidden shrink-0 flex flex-row items-start justify-center p-12 box-border max-w-full lg:pl-6 lg:pr-6 lg:box-border mq450:pt-5 mq450:pb-5 mq450:box-border mq1050:pt-[31px] mq1050:pb-[31px] mq1050:box-border">
